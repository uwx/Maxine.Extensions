...
namespace KeraLua
{
    ...
    /// </summary>
    public unsafe class Lua : IDisposable
    {
        ...
        /// </summary>
        public IntPtr Handle => (IntPtr) _luaState;
        ...
        /// </summary>
        /// <returns></returns>
        public IntPtr ExtraSpace => (IntPtr) _luaState - IntPtr.Size;
...
#if LUA_5_5
            _luaState = NativeMethods.lua_newstate(allocator.ToFunctionPointer(), (void*) ud, 0);
#else
            _luaState = NativeMethods.lua_newstate(allocator.ToFunctionPointer(), (void*) ud);
#endif
        ...
        public static Lua FromIntPtr(IntPtr luaState)
        {
            ...
            if (state != null && state._luaState == (lua_State*) luaState)
                return state;
        ...
        public void Close()
        {
            if ((IntPtr)_luaState == IntPtr.Zero || _mainState != null)
                return;

            NativeMethods.lua_close(_luaState);
            _luaState = (lua_State*)IntPtr.Zero;
            GC.SuppressFinalize(this);
        }
...
#pragma warning restore CA1063 // Implement IDisposable Correctly
        ...
        private void SetExtraObject<T>(T obj, bool weak) where T : class
        {
            ...
            IntPtr extraSpace = (IntPtr)_luaState - IntPtr.Size;
        ...
        public LuaFunction? AtPanic(LuaFunction panicFunction)
        {
            ...
            return DelegateExtensions.ToLuaFunction(NativeMethods.lua_atpanic(_luaState, newPanicPtr));
        }
        ...
        {
            NativeMethods.lua_callk(_luaState, arguments, results, IntPtr.Zero, null);
        }
        ...
        public void CallK(int arguments, int results, int context, LuaKFunction continuation)
        {
            ...
            NativeMethods.lua_callk(_luaState, arguments, results, context, k);
        }
        ...
        {
            return NativeMethods.lua_dump(_luaState, writer.ToFunctionPointer(), (void*)data, stripDebug ? 1 : 0);
        }
        ...
        {
            return NativeMethods.lua_gc(_luaState, (int)what, __arglist(data));
        }
        ...
        {
            return NativeMethods.lua_gc(_luaState, (int)what, __arglist(data, data2));
        }
        ...
        {
            fixed (IntPtr* pUd = &ud)
                return DelegateExtensions.ToLuaAlloc(NativeMethods.lua_getallocf(_luaState, (void**)pUd));
        }
        ...
        {
            return (LuaType)NativeMethods.lua_geti(_luaState, index, (IntPtr)i);
        }
        ...
        {
            return NativeMethods.lua_getinfo(_luaState, what, (lua_Debug*)ar) != 0;
        }
        ...
        {
            lua_Debug nativeDebug = new lua_Debug();
            bool ret = false;

            MarshalLuaDebug(ar, &nativeDebug);
            ret = NativeMethods.lua_getinfo(_luaState, what, &nativeDebug) != 0;
            UnmarshalLuaDebug(&nativeDebug, ref ar);
        ...
        {
            return NativeMethods.lua_getlocal(_luaState, (lua_Debug*)ar, n);
        }
        ...
        {
            return NativeMethods.lua_getstack(_luaState, level, (lua_Debug*)ar);
        }
        
        internal static void MarshalLuaDebug(in LuaDebug ar, lua_Debug* pDebug)
        {
            pDebug->@event = (int)ar.Event;
            pDebug->name = (byte*)ar.name;
            pDebug->namewhat = (byte*)ar.nameWhat;
            pDebug->what = (byte*)ar.what;
            pDebug->source = (byte*)ar.source;
            pDebug->srclen = (nuint)ar.sourceLen;
            pDebug->currentline = ar.CurrentLine;
            pDebug->linedefined = ar.LineDefined;
            pDebug->lastlinedefined = ar.LastLineDefined;
            pDebug->nups = ar.NumberUpValues;
            pDebug->nparams = ar.NumberParameters;
            pDebug->isvararg = (byte)(ar.IsVarArg ? 1 : 0);
            pDebug->istailcall = (byte)(ar.IsTailCall ? 1 : 0);
            pDebug->ftransfer = ar.IndexFirstValue;
            pDebug->ntransfer = ar.NumberTransferredValues;
            if (ar.shortSource != null) Marshal.Copy(ar.shortSource, 0, (IntPtr)(&pDebug->short_src.e0), Math.Min(60, ar.shortSource.Length));
            pDebug->i_ci = (lua_Debug.CallInfo*)ar.i_ci;
        }
        
        internal static void UnmarshalLuaDebug(lua_Debug* pDebug, ref LuaDebug ar)
        {
            ar.Event = (LuaHookEvent)pDebug->@event;
            ar.name = (IntPtr)pDebug->name;
            ar.nameWhat = (IntPtr)pDebug->namewhat;
            ar.what = (IntPtr)pDebug->what;
            ar.source = (IntPtr)pDebug->source;
            ar.sourceLen = (IntPtr)pDebug->srclen;
            ar.CurrentLine = pDebug->currentline;
            ar.LineDefined = pDebug->linedefined;
            ar.LastLineDefined = pDebug->lastlinedefined;
            ar.NumberUpValues = pDebug->nups;
            ar.NumberParameters = pDebug->nparams;
            ar.IsVarArg = pDebug->isvararg != 0;
            ar.IsTailCall = pDebug->istailcall != 0;
            ar.IndexFirstValue = (ushort)pDebug->ftransfer;
            ar.NumberTransferredValues = (ushort)pDebug->ntransfer;
            if (ar.shortSource == null || ar.shortSource.Length < 60)
                ar.shortSource = new byte[60];
            Marshal.Copy((IntPtr)(&pDebug->short_src.e0), ar.shortSource, 0, 60);
            ar.i_ci = (IntPtr)pDebug->i_ci;
        }
        ...
        public int GetStack(int level, ref LuaDebug ar)
        {
            ...
            MarshalLuaDebug(ar, &nativeDebug);
            ret = NativeMethods.lua_getstack(_luaState, level, &nativeDebug);
            UnmarshalLuaDebug(&nativeDebug, ref ar);
        ...
        /// </summary>
        public LuaHookFunction? Hook => DelegateExtensions.ToLuaHookFunction(NativeMethods.lua_gethook(_luaState));
        ...
        public Lua NewThread()
        {
            ...
            return new Lua((IntPtr)thread, this);
        }
        ...
        {
            return (IntPtr)NativeMethods.lua_newuserdatauv(_luaState, (UIntPtr)size, uv);
        }
        ...
        {
            return (LuaStatus)NativeMethods.lua_pcallk(_luaState, arguments, results, errorFunctionIndex, IntPtr.Zero, null);
        }
        ...
        /// </summary>
        /// <param name="n"></param>
        public void PushInteger(long n) => NativeMethods.lua_pushinteger(_luaState, (IntPtr)n);
        ...
        {
            NativeMethods.lua_pushlightuserdata(_luaState, (void*)data);
        }
...
#pragma warning restore RECS0017 // Possible compare of value type with 'null'
        ...
        public void PushBuffer(byte[] buffer)
        {
            ...
            NativeMethods.lua_pushlstring(_luaState, (ReadOnlySpan<byte>)buffer);
        }
        ...
        {
            return (LuaType)NativeMethods.lua_rawgeti(_luaState, index, (IntPtr)n);
        }
        ...
        {
            return (LuaType)NativeMethods.lua_rawgeti(_luaState, (int)index, (IntPtr)n);
        }
        ...
        public LuaType RawGetByHashCode(int index, object obj)
        {
            ...
            return (LuaType)NativeMethods.lua_rawgetp(_luaState, index, (void*)obj.GetHashCode());
        }
        ...
        {
            NativeMethods.lua_rawseti(_luaState, index, (IntPtr)i);
        }
        ...
        {
            NativeMethods.lua_rawseti(_luaState, (int)index, (IntPtr)i);
        }
        ...
        public void RawSetByHashCode(int index, object obj)
        {
            ...
            NativeMethods.lua_rawsetp(_luaState, index, (void*)obj.GetHashCode());
        }
        ...
        public LuaStatus Resume(Lua? from, int arguments, out int results)
        {
            fixed (int* pResults = &results)
                return (LuaStatus)NativeMethods.lua_resume(_luaState, from != null ? from._luaState : null, arguments, pResults);
        }
        ...
        {
            int ignore;
            return (LuaStatus)NativeMethods.lua_resume(_luaState, from != null ? from._luaState : null, arguments, &ignore);
        }
        ...
        {
            NativeMethods.lua_setallocf(_luaState, alloc.ToFunctionPointer(), (void*)ud);
        }
        ...
        {
            NativeMethods.lua_seti(_luaState, index, (IntPtr)n);
        }
        ...
        {
            return NativeMethods.lua_setlocal(_luaState, (lua_Debug*)ar, n);
        }
        ...
        {
            NativeMethods.lua_setwarnf(_luaState, function.ToFunctionPointer(), (void*)userData);
        }
        ...
        {
            return DelegateExtensions.ToLuaFunction(NativeMethods.lua_tocfunction(_luaState, index));
        }
...
#pragma warning restore IDE0018 // Inline variable declaration
            return NativeMethods.lua_tointegerx(_luaState, index, &isNum);
        }
        ...
        {
            int isInteger;
            long value = NativeMethods.lua_tointegerx(_luaState, index, &isInteger);
            if (isInteger != 0)
                return value;
            return null;
        }
        ...
        public byte[] ToBuffer(int index, bool callMetamethod)
        {
            ...
            if (callMetamethod)
            {
                buff = (IntPtr)NativeMethods.luaL_tolstring(_luaState, index, &len);
                Pop(1);
            }
            else
            {
                buff = (IntPtr)NativeMethods.lua_tolstring(_luaState, index, &len);
            }
        ...
        {
            int isNum;
            return NativeMethods.lua_tonumberx(_luaState, index, &isNum);
        }
        ...
        {
            int isNumber;
            double value = NativeMethods.lua_tonumberx(_luaState, index, &isNumber);
            if (isNumber != 0)
                return value;
            return null;
        }
        ...
        {
            return (IntPtr)NativeMethods.lua_topointer(_luaState, index);
        }
        ...
        {
            var state = NativeMethods.lua_tothread(_luaState, index);
            if (state == _luaState)
                return this;

            return FromIntPtr((IntPtr)state);
        }
        ...
        {
            return NativeMethods.lua_yieldk(_luaState, results, IntPtr.Zero, null);
        }
        ...
        {
            UIntPtr len;
            var buff = NativeMethods.luaL_checklstring(_luaState, argument, &len);
            if (buff == (void*)IntPtr.Zero)
                return null;
            ...
            byte[] output = new byte[length];
            Marshal.Copy((IntPtr)buff, output, 0, length);
            return output;
        }
        ...
        {
            return (IntPtr)NativeMethods.luaL_checkudata(_luaState, argument, typeName);
        }
        ...
        {
            return NativeMethods.luaL_optinteger(_luaState, argument, (IntPtr)d);
        }
        ...
        {
            NativeMethods.luaL_setfuncs(_luaState, library.Select(e => new luaL_RegManaged
            {
                name = e.name,
                func = e.function.ToFunctionPointer()
            }).ToArray(), numberUpValues);
        }
        ...
        {
            return (IntPtr)NativeMethods.luaL_testudata(_luaState, argument, typeName);
        }
