...
public partial class LuaBindings
{
    ...
    private static void Register_StringArray(lua_State L)
    {
        ...
        // __gc metamethod
        lua_pushcfunction(L, KeepAlive(StringArray__gc));
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, KeepAlive(StringArray__index));
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, KeepAlive(StringArray__newindex));
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, KeepAlive(StringArray__tostring));
