...
public unsafe partial class LuaBindings
{
    ...
    private static void Register_IList_Int32(lua_State L)
    {
        ...
        // __gc metamethod
        lua_pushcfunction(L, &IList_Int32__gc);
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, &IList_Int32__index);
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, &IList_Int32__newindex);
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, &IList_Int32__tostring);
        ...
        // Constructor: new()
        lua_pushcfunction(L, &IList_Int32_new);
    ...
    private static int IList_Int32__index(lua_State L)
    {
        ...
        switch (key)
        {
            ...
            case "removeAt":
                ...
                return 1;
            case "add":
                lua_pushcfunction(L, &IList_Int32_method_add);
                return 1;
            case "clear":
                lua_pushcfunction(L, &IList_Int32_method_clear);
                return 1;
            case "contains":
                lua_pushcfunction(L, &IList_Int32_method_contains);
                return 1;
            case "copyTo":
                lua_pushcfunction(L, &IList_Int32_method_copyTo);
                return 1;
            case "remove":
                lua_pushcfunction(L, &IList_Int32_method_remove);
                return 1;
            case "getEnumerator":
                lua_pushcfunction(L, &IList_Int32_method_getEnumerator);
                return 1;
            default:
                lua_pushnil(L);
                return 1;
