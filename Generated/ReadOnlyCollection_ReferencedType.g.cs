...
public partial class LuaBindings
{
    ...
    private static void Register_ReadOnlyCollection_ReferencedType(lua_State L)
    {
        ...
        lua_pushcfunction(L, (ReadOnlyCollection_ReferencedType__newindex));
    ...
    private static int ReadOnlyCollection_ReferencedType__index(lua_State L)
    {
        ...
        switch (key)
        {
            ...
            case "isSynchronized":
                ...
                return 1;
            case "contains":
                lua_pushcfunction(L, (ReadOnlyCollection_ReferencedType_method_contains));
                return 1;
            case "copyTo":
                lua_pushcfunction(L, (ReadOnlyCollection_ReferencedType_method_copyTo));
                return 1;
            case "getEnumerator":
                lua_pushcfunction(L, (ReadOnlyCollection_ReferencedType_method_getEnumerator));
                return 1;
            case "indexOf":
                lua_pushcfunction(L, (ReadOnlyCollection_ReferencedType_method_indexOf));
                return 1;
            case "getType":
    ...
    private static int ReadOnlyCollection_ReferencedType_method_contains(lua_State L)
    {
        ...
        if (argCount == 1)
        {
            ...
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<NFMWorld.LuaSourceGenerator.Test.SampleTypes.ReferencedType>)self).Contains(arg0);
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_ReferencedType_method_copyTo(lua_State L)
    {
        ...
        if (argCount == 2)
        {
            ...
            try
            {
                ((System.Collections.ObjectModel.ReadOnlyCollection<NFMWorld.LuaSourceGenerator.Test.SampleTypes.ReferencedType>)self).CopyTo(arg0, arg1);
                return 0;
            }
            catch (System.Exception ex)
            {
    ...
    private static int ReadOnlyCollection_ReferencedType_method_getEnumerator(lua_State L)
    {
        ...
        if (argCount == 0)
        {
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<NFMWorld.LuaSourceGenerator.Test.SampleTypes.ReferencedType>)self).GetEnumerator();
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_ReferencedType_method_indexOf(lua_State L)
    {
        ...
        if (argCount == 1)
        {
            ...
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<NFMWorld.LuaSourceGenerator.Test.SampleTypes.ReferencedType>)self).IndexOf(arg0);
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
