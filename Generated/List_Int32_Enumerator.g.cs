    ...
    private static int List_Int32_Enumerator__index(lua_State L)
    {
        ...
        switch (key)
        {
            ...
            case "moveNext":
                ...
                return 1;
            case "equals":
                lua_pushcfunction(L, (List_Int32_Enumerator_method_equals));
                return 1;
            case "getHashCode":
                lua_pushcfunction(L, (List_Int32_Enumerator_method_getHashCode));
                return 1;
            case "toString":
                lua_pushcfunction(L, (List_Int32_Enumerator_method_toString));
                return 1;
            case "getType":
