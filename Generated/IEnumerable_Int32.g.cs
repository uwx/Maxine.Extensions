...
public partial class LuaBindings
{
    ...
    private static void Register_IEnumerable_Int32(lua_State L)
    {
        ...
        // __gc metamethod
        lua_pushcfunction(L, (IEnumerable_Int32__gc));
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, (IEnumerable_Int32__index));
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, (IEnumerable_Int32__newindex));
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, (IEnumerable_Int32__tostring));
        ...
        // Constructor: new()
        lua_pushcfunction(L, (IEnumerable_Int32_new));
