...
public partial class LuaBindings
{
    ...
    private static void Register_IEnumerator_Int32(lua_State L)
    {
        ...
        // __gc metamethod
        lua_pushcfunction(L, (IEnumerator_Int32__gc));
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, (IEnumerator_Int32__index));
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, (IEnumerator_Int32__newindex));
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, (IEnumerator_Int32__tostring));
        ...
        // Constructor: new()
        lua_pushcfunction(L, (IEnumerator_Int32_new));
    ...
    private static int IEnumerator_Int32__index(lua_State L)
    {
        ...
        {
            case "current":
                PushValue(L, ((System.Collections.Generic.IEnumerator<int>)obj).Current);
                return 1;
            case "dispose":
                lua_pushcfunction(L, (IEnumerator_Int32_method_dispose));
                return 1;
            case "moveNext":
                lua_pushcfunction(L, (IEnumerator_Int32_method_moveNext));
                return 1;
            case "reset":
                lua_pushcfunction(L, (IEnumerator_Int32_method_reset));
                return 1;
            default:
                lua_pushnil(L);
                return 1;
    ...
    private static int IEnumerator_Int32_method_dispose(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self

        var self = GetObjectFromStack<System.Collections.Generic.IEnumerator<int>>(L, 1);
        if (self == null)
        {
    ...
    private static int IEnumerator_Int32_method_moveNext(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
    ...
    private static int IEnumerator_Int32_method_reset(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
