...
namespace Maxine.Extensions.Lua55
{
    public static unsafe partial class Lua55
    {
        ...
        /// [-0, +0, e]<br/>
        /// <br/>
        /// Opens (loads) and preloads selected standard libraries into the state L. (To preload means to add the library loader into the table package.preload, so that the library can be required later by the program. Keep in mind that require itself is provided by the package library. If a program does not load that library, it will be unable to require anything.)<br/>
        /// <br/>
        /// The integer load selects which libraries to load; the integer preload selects which to preload, among those not loaded. Both are masks formed by a bitwise OR of the following constants:<br/>
        /// <br/>
        /// - LUA_GLIBK : the basic library.<br/>
        /// - LUA_LOADLIBK : the package library.<br/>
        /// - LUA_COLIBK : the coroutine library.<br/>
        /// - LUA_STRLIBK : the string library.<br/>
        /// - LUA_UTF8LIBK : the UTF-8 library.<br/>
        /// - LUA_TABLIBK : the table library.<br/>
        /// - LUA_MATHLIBK : the mathematical library.<br/>
        /// - LUA_IOLIBK : the I/O library.<br/>
        /// - LUA_OSLIBK : the operating system library.<br/>
        /// - LUA_DBLIBK : the debug library.<br/>
        /// <br/>
        /// </summary>
        /// <code>
