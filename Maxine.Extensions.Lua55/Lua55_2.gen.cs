...
namespace Maxine.Extensions.Lua55
{
    public static unsafe partial class Lua55
    {
        ...
        public static extern lua_State* lua_newstate(lua_Alloc f, void* ud, [NativeTypeName("unsigned int")] uint seed);
        ...
        /// [-0, +?, –]<br/>
        /// <br/>
        /// Resets a thread, cleaning its call stack and closing all pending to-be-closed variables. The parameter from represents the coroutine that is resetting L. If there is no such coroutine, this parameter can be NULL.<br/>
        /// <br/>
        /// Unless L is equal to from, the call returns a status code: LUA_OK for no errors in the thread (either the original error that stopped the thread or errors in closing methods), or an error status otherwise. In case of error, the error object is put on the top of the stack.<br/>
        /// <br/>
        /// If L is equal to from, it corresponds to a thread closing itself. In that case, the call does not return; instead, the resume that (re)started the thread returns. The thread must be running inside a resume.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// </code>
        [DllImport("lua550", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_version", ExactSpelling = true)]
        [SuppressGCTransition]
        ...
        /// [-?, +?, e]<br/>
        /// <br/>
        /// Receives any acceptable stack index, or 0, and sets the stack top to this index. If the new top is greater than the old one, then the new elements are filled with nil. If index is 0, then all stack elements are removed.<br/>
        /// <br/>
        ...
        /// </code>
        [DllImport("lua550", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_typename", ExactSpelling = true)]
        ...
        /// <br/>
        /// If len is not NULL, the function sets *len with the string length. The returned C string always has a zero ('\0') after its last character, but can contain other zeros in its body.<br/>
        /// <br/>
        /// The pointer returned by lua_tolstring may be invalidated by the garbage collector if the corresponding Lua value is removed from the stack (see §4.1.3).<br/>
        /// <br/>
        ...
        /// <br/>
        /// Besides memory allocation errors, this function may raise an error if the string is too large.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        [DllImport("lua550", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        public static extern byte* lua_pushexternalstring(lua_State* L, [NativeTypeName("const char *")] byte* s, [NativeTypeName("size_t")] nuint len, lua_Alloc falloc, void* ud);
        ...
        /// [-0, +1, –]<br/>
        /// <br/>
        /// Equivalent to lua_pushfstring, except that it receives a va_list instead of a variable number of arguments, and it does not raise errors. Instead, in case of errors it pushes the error message and returns NULL.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, v]<br/>
        /// <br/>
        /// Pushes onto the stack a formatted string and returns a pointer to this string (see §4.1.3). The result is a copy of fmt with each conversion specifier replaced by a string representation of its respective extra argument. A conversion specifier (and its corresponding extra argument) can be '%%' (inserts the character '%'), '%s' (inserts a zero-terminated string, with no size restrictions), '%f' (inserts a lua_Number), '%I' (inserts a lua_Integer), '%p' (inserts a void pointer), '%d' (inserts an int), '%c' (inserts an int as a one-byte character), and '%U' (inserts an unsigned long as a UTF-8 byte sequence).<br/>
        /// <br/>
        /// Every occurrence of '%' in the string fmt must form a valid conversion specifier.<br/>
        /// <br/>
        /// Besides memory allocation errors, this function may raise an error if the resulting string is too large.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, m]<br/>
        /// <br/>
        /// Creates a new empty table and pushes it onto the stack. Parameter nseq is a hint for how many elements the table will have as a sequence; parameter nrec is a hint for how many other elements the table will have. Lua may use these hints to preallocate memory for the new table. This preallocation may help performance when you know in advance how many elements the table will have. Otherwise you should use the function lua_newtable.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// <br/>
        /// The function lua_load fully preserves the Lua stack through the calls to the reader function, except that it may push some values for internal use before the first call, and it restores the stack size to its original size plus one (for the pushed result) after the last call.<br/>
        /// <br/>
        ...
        /// <br/>
        /// The function lua_dump fully preserves the Lua stack through the calls to the writer function, except that it may push some values for internal use before the first call, and it restores the stack size to its original size after the last call.<br/>
        /// <br/>
        ...
        /// <br/>
        /// To resume a suspended coroutine, you remove the *nresults yielded values from its stack, push the values to be passed as results from yield, and then call lua_resume.<br/>
        /// <br/>
        ...
        /// - LUA_GCSTEP (size_t n): Performs a step of garbage collection.<br/>
        /// - LUA_GCISRUNNING: Returns a boolean that tells whether the collector is running (i.e., not stopped).<br/>
        /// - LUA_GCINC: Changes the collector to incremental mode. Returns the previous mode (LUA_GCGEN or LUA_GCINC).<br/>
        /// - LUA_GCGEN: Changes the collector to generational mode. Returns the previous mode (LUA_GCGEN or LUA_GCINC).<br/>
        /// - LUA_GCPARAM (int param, int val): Changes and/or returns the value of a parameter of the collector. If val is -1, the call only returns the current value. The argument param must have one of the following values: LUA_GCPMINORMUL: The minor multiplier. LUA_GCPMAJORMINOR: The major-minor multiplier. LUA_GCPMINORMAJOR: The minor-major multiplier. LUA_GCPPAUSE: The garbage-collector pause. LUA_GCPSTEPMUL: The step multiplier. LUA_GCPSTEPSIZE: The step size.<br/>
        /// - LUA_GCPMINORMUL: The minor multiplier.<br/>
        /// - LUA_GCPMAJORMINOR: The major-minor multiplier.<br/>
        /// - LUA_GCPMINORMAJOR: The minor-major multiplier.<br/>
        /// - LUA_GCPPAUSE: The garbage-collector pause.<br/>
        /// - LUA_GCPSTEPMUL: The step multiplier.<br/>
        /// - LUA_GCPSTEPSIZE: The step size.<br/>
        /// <br/>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Converts the number at acceptable index idx to a string and puts the result in buff. The buffer must have a size of at least LUA_N2SBUFFSZ bytes. The conversion follows a non-specified format (see §3.4.3). The function returns the number of bytes written to the buffer (including the final zero), or zero if the value at idx is not a number.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        public static extern uint lua_numbertocstring(lua_State* L, int idx, [NativeTypeName("char *")] byte* buff);
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Returns the memory-allocator function of a given state. If ud is not NULL, Lua stores in *ud the opaque pointer given when the memory-allocator function was set.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// - 't': fills in the fields istailcall and extraargs;<br/>
        ...
        /// </code>
        [DllImport("lua550", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_getlocal", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// </code>
        [DllImport("lua550", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_setlocal", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// </code>
        [DllImport("lua550", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_getupvalue", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// </code>
        [DllImport("lua550", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_setupvalue", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// <br/>
        /// All functions and types from the auxiliary library are defined in the header file lauxlib.h and have a prefix luaL_.<br/>
        /// <br/>
