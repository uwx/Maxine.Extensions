...
namespace Maxine.Extensions.Lua55
{
    ...
    /// - namewhat: explains the name field. The value of namewhat can be "global", "local", "upvalue", "field", "" (the empty string), plus some other options, according to how the function was called. (Lua uses the empty string when no other option seems to apply.)<br/>
    ...
    /// - extraargs: The number of extra arguments added by the call to functions called through __call metamethods. (Each __call metavalue adds a single extra argument, the object being called, but there may be a chain of __call metavalues.)<br/>
