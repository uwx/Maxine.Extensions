...
public struct Double2 : IEquatable<Double2>, ISpanFormattable
{
    ...
    /// </summary>
    public static readonly Double2 Zero = new();
    ...
    /// <remarks>
    /// <see cref="Double2.LengthSquared"/> may be preferred when only the relative length is needed
    ...
    /// <remarks>
    /// This method may be preferred to <see cref="Double2.Length"/> when only a relative length is needed
    /// and speed is of the essence.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <remarks>
    /// <see cref="DistanceSquared(ref readonly Double2, ref readonly Double2, out double)"/> may be preferred when only the relative distance is needed
    /// and speed is of the essence.
    /// </remarks>
    ...
    /// <returns>
    /// 	<c>true</c> if the specified <see cref="Double2"/> is equal to this instance; otherwise, <c>false</c>.
    /// </returns>
    ...
    {
        return value is Double2 d && Equals(d);
    }
...
#if WPFInterop
    /// <summary>
    /// Performs an implicit conversion from <see cref="Maxine.Extensions.Mathematics.Double2"/> to <see cref="System.Windows.Point"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="System.Windows.Point"/> to <see cref="Maxine.Extensions.Mathematics.Double2"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
...
#if XnaInterop
    /// <summary>
    /// Performs an implicit conversion from <see cref="Maxine.Extensions.Mathematics.Double2"/> to <see cref="Microsoft.Xna.Framework.Vector2"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector2"/> to <see cref="Maxine.Extensions.Mathematics.Double2"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
