...
public struct Double3 : IEquatable<Double3>, ISpanFormattable
{
    /// <summary>
    ...
    /// <remarks>
    /// <see cref="DistanceSquared(ref readonly Double3, ref readonly Double3, out double)"/> may be preferred when only the relative distance is needed
    /// and speed is of the essence.
    /// </remarks>
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="Double3"/> to <see cref="Vector3"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    ...
    {
        return value is Double3 d && Equals(d);
    }
...
#if WPFInterop
    /// <summary>
    /// Performs an implicit conversion from <see cref="Maxine.Extensions.Mathematics.Double3"/> to <see cref="System.Windows.Media.Media3D.Double3D"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="System.Windows.Media.Media3D.Double3D"/> to <see cref="Maxine.Extensions.Mathematics.Double3"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
...
#if XnaInterop
    /// <summary>
    /// Performs an implicit conversion from <see cref="Maxine.Extensions.Mathematics.Double3"/> to <see cref="Microsoft.Xna.Framework.Vector3"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector3"/> to <see cref="Maxine.Extensions.Mathematics.Double3"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
