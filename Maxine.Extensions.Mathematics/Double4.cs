...
public struct Double4 : IEquatable<Double4>, ISpanFormattable
{
    /// <summary>
    ...
    /// </summary>
    public static readonly Double4 Zero = new();
    ...
    /// <remarks>
    /// <see cref="Double4.DistanceSquared(ref readonly Double4, ref readonly Double4, out double)"/> may be preferred when only the relative distance is needed
    /// and speed is of the essence.
    /// </remarks>
    ...
    /// <remarks>
    /// <see cref="DistanceSquared(Double4, Double4)"/> may be preferred when only the relative distance is needed
    /// and speed is of the essence.
    /// </remarks>
    ...
    /// <returns>
    /// <c>true</c> if the specified <see cref="Double4"/> is equal to this instance; otherwise, <c>false</c>.
    /// </returns>
    ...
    {
        return value is Double4 d && Equals(d);
    }
...
#if WPFInterop
    /// <summary>
    /// Performs an implicit conversion from <see cref="Maxine.Extensions.Mathematics.Double4"/> to <see cref="System.Windows.Media.Media3D.Point4D"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="System.Windows.Media.Media3D.Point4D"/> to <see cref="Maxine.Extensions.Mathematics.Double4"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
...
#if XnaInterop
    /// <summary>
    /// Performs an implicit conversion from <see cref="Maxine.Extensions.Mathematics.Double4"/> to <see cref="Microsoft.Xna.Framework.Vector4"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector4"/> to <see cref="Maxine.Extensions.Mathematics.Double4"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
