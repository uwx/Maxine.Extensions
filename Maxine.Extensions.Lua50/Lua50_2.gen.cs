...
namespace Maxine.Extensions.Lua50
{
    public static unsafe partial class Lua50
    {
        ...
        [DllImport("lua503", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_tostring", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        public static extern byte* _lua_tostring(lua_State* L, int idx);
