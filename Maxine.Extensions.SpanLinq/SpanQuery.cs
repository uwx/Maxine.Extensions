    ...
    where TEnumerator : struct, ISpanEnumerator<TSpan, TElement>
{
    ...
    /// </summary>
    public SpanQuery<TSpan, TElement[], ChunkToArrayEnumerator<TSpan, TElement, TEnumerator>> Chunk(
        int size)
    {
        return With<TElement[], ChunkToArrayEnumerator<TSpan, TElement, TEnumerator>>(
            new ChunkToArrayEnumerator<TSpan, TElement, TEnumerator>(
                _enumerator,
                size)
            );
    }
