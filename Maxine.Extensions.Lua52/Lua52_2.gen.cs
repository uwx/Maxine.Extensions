...
namespace Maxine.Extensions.Lua52
{
    public static unsafe partial class Lua52
    {
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Creates a new thread running in a new, independent state. Returns NULL if cannot create the thread or the state (due to lack of memory). The argument f is the allocator function; Lua does all memory allocation for this state through this function. The second argument, ud, is an opaque pointer that Lua passes to the allocator in every call.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Destroys all objects in the given Lua state (calling the corresponding garbage-collection metamethods, if any) and frees all dynamic memory used by this state. On several platforms, you may not need to call this function, because all resources are naturally released when the host program ends. On the other hand, long-running programs that create multiple states, such as daemons or web servers, might need to close states as soon as they are not needed.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Sets a new panic function and returns the old one (see §4.6).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, v]<br/>
        /// <br/>
        /// Returns the address of the version number stored in the Lua core. When called with a valid lua_State, returns the address of the version used to create that state. When called with NULL, returns the address of the version running the call.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        /// const lua_Number *lua_version (lua_State *L);
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_version", ExactSpelling = true)]
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Converts the acceptable index idx into an absolute index (that is, one that does not depend on the stack top).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-?, +?, –]<br/>
        /// <br/>
        /// Accepts any index, or 0, and sets the stack top to this index. If the new top is larger than the old one, then the new elements are filled with nil. If index is 0, then all stack elements are removed.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-1, +0, –]<br/>
        /// <br/>
        /// Removes the element at the given valid index, shifting down the elements above this index to fill the gap. This function cannot be called with a pseudo-index, because a pseudo-index is not an actual stack position.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-1, +1, –]<br/>
        /// <br/>
        /// Moves the top element into the given valid index, shifting up the elements above this index to open space. This function cannot be called with a pseudo-index, because a pseudo-index is not an actual stack position.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-1, +0, –]<br/>
        /// <br/>
        /// Moves the top element into the given valid index without shifting any element (therefore replacing the value at the given index), and then pops the top element.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Moves the element at index fromidx into the valid index toidx without shifting any element (therefore replacing the value at that position).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Ensures that there are at least extra free stack slots in the stack. It returns false if it cannot fulfill the request, because it would cause the stack to be larger than a fixed maximum size (typically at least a few thousand elements) or because it cannot allocate memory for the new stack size. This function never shrinks the stack; if the stack is already larger than the new size, it is left unchanged.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_typename", ExactSpelling = true)]
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Converts the Lua value at the given index to the C type lua_Number (see lua_Number). The Lua value must be a number or a string convertible to a number (see §3.4.2); otherwise, lua_tonumberx returns 0.<br/>
        /// <br/>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Converts the Lua value at the given index to the signed integral type lua_Integer. The Lua value must be a number or a string convertible to a number (see §3.4.2); otherwise, lua_tointegerx returns 0.<br/>
        /// <br/>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Converts the Lua value at the given index to the unsigned integral type lua_Unsigned. The Lua value must be a number or a string convertible to a number (see §3.4.2); otherwise, lua_tounsignedx returns 0.<br/>
        /// <br/>
        /// If the number is not an integer, it is truncated in some non-specified way. If the number is outside the range of representable values, it is normalized to the remainder of its division by one more than the maximum representable value.<br/>
        /// <br/>
        /// If isnum is not NULL, its referent is assigned a boolean value that indicates whether the operation succeeded.<br/>
        /// <br/>
        /// </summary>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern lua_Unsigned lua_tounsignedx(lua_State* L, int idx, int* isnum);
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Returns the raw "length" of the value at the given index: for strings, this is the string length; for tables, this is the result of the length operator ('#') with no metamethods; for userdata, this is the size of the block of memory allocated for the userdata; for other values, it is 0.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// If the value at the given index is a full userdata, returns its block address. If the value is a light userdata, returns its pointer. Otherwise, returns NULL.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Converts the value at the given index to a generic C pointer (void*). The value can be a userdata, a table, a thread, or a function; otherwise, lua_topointer returns NULL. Different objects will give different pointers. There is no way to convert the pointer back to its original value.<br/>
        /// <br/>
        ...
        /// [-(2|1), +1, e]<br/>
        /// <br/>
        /// Performs an arithmetic operation over the two values (or one, in the case of negation) at the top of the stack, with the value at the top being the second operand, pops these values, and pushes the result of the operation. The function follows the semantics of the corresponding Lua operator (that is, it may call metamethods).<br/>
        /// <br/>
        ...
        /// - LUA_OPDIV: performs division (/)<br/>
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Returns 1 if the two values in indices index1 and index2 are primitively equal (that is, without calling metamethods). Otherwise returns 0. Also returns 0 if any of the indices are non valid.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +0, e]<br/>
        /// <br/>
        /// Compares two Lua values. Returns 1 if the value at index index1 satisfies op when compared with the value at index index2, following the semantics of the corresponding Lua operator (that is, it may call metamethods). Otherwise returns 0. Also returns 0 if any of the indices is non valid.<br/>
        /// <br/>
        /// The value of op must be one of the following constants:<br/>
        /// <br/>
        ...
        /// [-0, +1, e]<br/>
        /// <br/>
        /// Pushes the string pointed to by s with size len onto the stack. Lua makes (or reuses) an internal copy of the given string, so the memory at s can be freed or reused immediately after the function returns. The string can contain any binary data, including embedded zeros.<br/>
        /// <br/>
        /// Returns a pointer to the internal copy of the string.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        public static extern byte* lua_pushlstring(lua_State* L, [NativeTypeName("const char *")] byte* s, [NativeTypeName("size_t")] nuint l);

        /// <summary>
        /// [-0, +1, e]<br/>
        /// <br/>
        /// Pushes the zero-terminated string pointed to by s onto the stack. Lua makes (or reuses) an internal copy of the given string, so the memory at s can be freed or reused immediately after the function returns.<br/>
        /// <br/>
        /// Returns a pointer to the internal copy of the string.<br/>
        /// <br/>
        ...
        /// [-0, +1, e]<br/>
        /// <br/>
        /// Pushes onto the stack a formatted string and returns a pointer to this string. It is similar to the ISO C function sprintf, but has some important differences:<br/>
        /// <br/>
        ...
        /// - The conversion specifiers are quite restricted. There are no flags, widths, or precisions. The conversion specifiers can only be '%%' (inserts a '%' in the string), '%s' (inserts a zero-terminated string, with no size restrictions), '%f' (inserts a lua_Number), '%p' (inserts a pointer as a hexadecimal numeral), '%d' (inserts an int), and '%c' (inserts an int as a byte).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// <br/>
        /// When n is zero, this function creates a light C function, which is just a pointer to the C function. In that case, it never throws a memory error.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, e]<br/>
        /// <br/>
        /// Pushes onto the stack the value of the global name.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void lua_getglobal(lua_State* L, [NativeTypeName("const char *")] byte* var);

        /// <summary>
        /// [-1, +1, e]<br/>
        /// <br/>
        /// Pushes onto the stack the value t[k], where t is the value at the given index and k is the value at the top of the stack.<br/>
        /// <br/>
        /// This function pops the key from the stack (putting the resulting value in its place). As in Lua, this function may trigger a metamethod for the "index" event (see §2.4).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, –]<br/>
        /// <br/>
        /// Pushes onto the stack the value t[n], where t is the table at the given index. The access is raw; that is, it does not invoke metamethods.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, –]<br/>
        /// <br/>
        /// Pushes onto the stack the value t[k], where t is the table at the given index and k is the pointer p represented as a light userdata. The access is raw; that is, it does not invoke metamethods.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void lua_rawgetp(lua_State* L, int idx, [NativeTypeName("const void *")] void* p);

        /// <summary>
        /// [-0, +1, e]<br/>
        /// <br/>
        /// Creates a new empty table and pushes it onto the stack. Parameter narr is a hint for how many elements the table will have as a sequence; parameter nrec is a hint for how many other elements the table will have. Lua may use these hints to preallocate memory for the new table. This pre-allocation is useful for performance when you know in advance how many elements the table will have. Otherwise you can use the function lua_newtable.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, e]<br/>
        /// <br/>
        /// This function allocates a new block of memory with the given size, pushes onto the stack a new full userdata with the block address, and returns this address. The host program can freely use this memory.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +(0|1), –]<br/>
        /// <br/>
        /// Pushes onto the stack the metatable of the value at the given index. If the value does not have a metatable, the function returns 0 and pushes nothing on the stack.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, –]<br/>
        /// <br/>
        /// Pushes onto the stack the Lua value associated with the userdata at the given index. This Lua value must be a table or nil.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void lua_setglobal(lua_State* L, [NativeTypeName("const char *")] byte* var);

        /// <summary>
        /// [-2, +0, e]<br/>
        /// <br/>
        /// Does the equivalent to t[k] = v, where t is the value at the given index, v is the value at the top of the stack, and k is the value just below the top.<br/>
        /// <br/>
        ...
        /// [-1, +0, e]<br/>
        /// <br/>
        /// Does the equivalent to t[k] = v, where t is the value at the given index and v is the value at the top of the stack.<br/>
        /// <br/>
        ...
        /// [-1, +0, e]<br/>
        /// <br/>
        /// Does the equivalent of t[n] = v, where t is the table at the given index and v is the value at the top of the stack.<br/>
        /// <br/>
        ...
        /// [-1, +0, e]<br/>
        /// <br/>
        /// Does the equivalent of t[k] = v, where t is the table at the given index, k is the pointer p represented as a light userdata, and v is the value at the top of the stack.<br/>
        /// <br/>
        /// This function pops the value from the stack. The assignment is raw; that is, it does not invoke metamethods.<br/>
        /// <br/>
        /// </summary>
        ...
        /// [-1, +0, –]<br/>
        /// <br/>
        /// Pops a table from the stack and sets it as the new metatable for the value at the given index.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-1, +0, –]<br/>
        /// <br/>
        /// Pops a table or nil from the stack and sets it as the new value associated to the userdata at the given index.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// <br/>
        /// This function behaves exactly like lua_call, but allows the called function to yield (see §4.7).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void lua_callk(lua_State* L, int nargs, int nresults, int ctx, lua_CFunction k);

        /// <summary>
        /// [-0, +0, –]<br/>
        /// <br/>
        /// This function is called by a continuation function (see §4.7) to retrieve the status of the thread and a context information.<br/>
        /// <br/>
        ...
        /// <br/>
        /// This function behaves exactly like lua_pcall, but allows the called function to yield (see §4.7).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int lua_pcallk(lua_State* L, int nargs, int nresults, int errfunc, int ctx, lua_CFunction k);
        ...
        /// <br/>
        /// The return values of lua_load are:<br/>
        /// <br/>
        /// - LUA_OK: no errors;<br/>
        /// - LUA_ERRSYNTAX: syntax error during precompilation;<br/>
        ...
        /// <br/>
        /// When a C function calls lua_yieldk in that way, the running coroutine suspends its execution, and the call to lua_resume that started this coroutine returns. The parameter nresults is the number of values from the stack that are passed as results to lua_resume.<br/>
        /// <br/>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int lua_yieldk(lua_State* L, int nresults, int ctx, lua_CFunction k);
        ...
        /// <br/>
        /// To start a coroutine, you push onto the thread stack the main function plus any arguments; then you call lua_resume, with nargs being the number of arguments. This call returns when the coroutine suspends or finishes its execution. When it returns, the stack contains all values passed to lua_yield, or all values returned by the body function. lua_resume returns LUA_YIELD if the coroutine yields, LUA_OK if the coroutine finishes its execution without errors, or an error code in case of errors (see lua_pcall).<br/>
        /// <br/>
        /// In case of errors, the stack is not unwound, so you can use the debug API over it. The error message is on the top of the stack.<br/>
        /// <br/>
        /// To resume a coroutine, you remove any results from the last lua_yield, put on its stack only the values to be passed as results from yield, and then call lua_resume.<br/>
        /// <br/>
        ...
        /// <br/>
        /// The status can be 0 (LUA_OK) for a normal thread, an error code if the thread finished the execution of a lua_resume with an error, or LUA_YIELD if the thread is suspended.<br/>
        /// <br/>
        /// You can only call functions in threads with status LUA_OK. You can resume threads with status LUA_OK (to start a new coroutine) or LUA_YIELD (to resume a coroutine).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// - LUA_GCSETPAUSE: sets data as the new value for the pause of the collector (see §2.5). The function returns the previous value of the pause.<br/>
        /// - LUA_GCSETSTEPMUL: sets data as the new value for the step multiplier of the collector (see §2.5). The function returns the previous value of the step multiplier.<br/>
        /// - LUA_GCISRUNNING: returns a boolean that tells whether the collector is running (i.e., not stopped).<br/>
        /// - LUA_GCGEN: changes the collector to generational mode (see §2.5).<br/>
        /// - LUA_GCINC: changes the collector to incremental mode. This is the default mode.<br/>
        /// <br/>
        ...
        /// <br/>
        /// While traversing a table, do not call lua_tolstring directly on a key, unless you know that the key is actually a string. Recall that lua_tolstring may change the value at the given index; this confuses the next call to lua_next.<br/>
        /// <br/>
        ...
        /// [-n, +1, e]<br/>
        /// <br/>
        /// Concatenates the n values at the top of the stack, pops them, and leaves the result at the top. If n is 1, the result is the single value on the stack (that is, the function does nothing); if n is 0, the result is the empty string. Concatenation is performed following the usual semantics of Lua (see §3.4.5).<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +1, e]<br/>
        /// <br/>
        /// Returns the "length" of the value at the given index; it is equivalent to the '#' operator in Lua (see §3.4.6). The result is pushed on the stack.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// <br/>
        /// This function fills parts of a lua_Debug structure with an identification of the activation record of the function executing at a given level. Level 0 is the current running function, whereas level n+1 is the function that has called level n (except for tail calls, which do not count on the stack). When there are no errors, lua_getstack returns 1; when called with a level greater than the stack depth, it returns 0.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// [-0, +(0|1), –]<br/>
        /// <br/>
        /// Gets information about a local variable of a given activation record or a given function.<br/>
        /// <br/>
        ...
        /// <br/>
        /// In the second case, ar should be NULL and the function to be inspected must be at the top of the stack. In this case, only parameters of Lua functions are visible (as there is no information about what variables are active) and no values are pushed onto the stack.<br/>
        /// <br/>
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_getlocal", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_setlocal", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_getupvalue", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// </code>
        [DllImport("lua524", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_setupvalue", ExactSpelling = true)]
        [return: NativeTypeName("const char *")]
        [SuppressGCTransition]
        ...
        /// [-0, +0, –]<br/>
        /// <br/>
        /// Returns an unique identifier for the upvalue numbered n from the closure at index funcindex. Parameters funcindex and n are as in the lua_getupvalue (see lua_getupvalue) (but n cannot be greater than the number of upvalues).<br/>
        /// <br/>
        ...
        /// <br/>
        /// Functions called luaL_check* always throw an error if the check is not satisfied.<br/>
        /// <br/>
        /// </summary>
        /// <code>
        ...
        /// - The return hook: is called when the interpreter returns from a function. The hook is called just before Lua leaves the function. There is no standard way to access the values to be returned by the function.<br/>
