...
namespace Maxine.Extensions.Lua51
{
    ...
    /// <br/>
    /// - First you declare a variable b of type luaL_Buffer.<br/>
    /// - Then you initialize it with a call luaL_buffinit(L, &amp;b).<br/>
    /// - Then you add string pieces to the buffer calling any of the luaL_add* functions.<br/>
    /// - You finish by calling luaL_pushresult(&amp;b). This call leaves the final string on the top of the stack.<br/>
    /// <br/>
