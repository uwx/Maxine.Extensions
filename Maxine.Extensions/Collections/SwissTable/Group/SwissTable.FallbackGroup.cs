...
internal struct FallbackBitMask : IBitMask<FallbackBitMask>
{
    ...
    public int LeadingZeros()
    {
        ...
        // So it is 64 - 32 = 32
        return (BitOperations.LeadingZeroCount(_data) - 32) >> BITMASK_SHIFT;
#endif
    }
    ...
    {
        return BitOperations.TrailingZeroCount(_data) >> BITMASK_SHIFT;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public FallbackBitMask And(FallbackBitMask bitMask)
    {
        return new FallbackBitMask(_data & ((FallbackBitMask)bitMask)._data);
    }
}
...
internal struct FallbackGroup : IGroup<FallbackBitMask, FallbackGroup>
{
    ...
    public FallbackGroup convert_special_to_empty_and_full_to_deleted()
    {
        ...
        var full = ~_data & unchecked((nuint)0x8080_8080_8080_8080);
        var q = (full >> 7);
        var w = ~full + q;
    ...
    public FallbackBitMask MatchEmpty()
    {
        ...
        return new FallbackBitMask(_data & _data << 1 & unchecked((nuint)0x8080_8080_8080_8080));
    }
    ...
    public FallbackBitMask MatchEmptyOrDeleted()
    {
        ...
        return new FallbackBitMask(_data & unchecked((nuint)0x8080_8080_8080_8080));
    }
