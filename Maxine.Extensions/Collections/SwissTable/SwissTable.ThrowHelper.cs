...
namespace Maxine.Extensions.Collections
{
    ...
    internal static partial class SR
    {
        ...
        internal static string GetResourceString(string resourceKey)
        {
            ...
            var resourceString = "";  // We do not have any real resource, so we set it to "" rather than `null` in dotnet/runtime.
            try
            {
    ...
    internal static partial class SR
    {
        ...
        internal static ResourceManager ResourceManager => s_resourceManager ?? (s_resourceManager = new ResourceManager(typeof(System.Private.CoreLib.Strings)));
