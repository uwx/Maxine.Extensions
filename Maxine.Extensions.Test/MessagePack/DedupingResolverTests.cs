...
[TestClass]
public class DedupingResolverTests
{
    ...
    {
        var resolver = DedupingResolver.Create(StandardResolver.Instance);

        Assert.IsNotNull(resolver);
        Assert.IsInstanceOfType<DedupingResolver<StandardResolver>>(resolver);
    }
