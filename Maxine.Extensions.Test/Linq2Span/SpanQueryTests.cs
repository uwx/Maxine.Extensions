...
public class SpanQueryTests : TestBase
{
    ...
    public void Test_ElementAt()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpanQuery().ElementAt(10));
    }
    ...
    public void Test_ElementAt_Index()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpanQuery().ElementAt((Index)10));
        Assert.AreEqual(10, OneToTen.AsSpanQuery().ElementAt(^1));
        Assert.AreEqual(1, OneToTen.AsSpanQuery().ElementAt(^10));
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpanQuery().ElementAt(^0));
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpanQuery().ElementAt(^11));
    }
    ...
    public void Test_First()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => none.AsSpanQuery().First());
    }
    ...
    public void Test_First_Predicate()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpanQuery().First(x => x > 10));
    }
    ...
    {
        AssertAreEquivalent(
            OneToTen.GroupJoin(OneToTen, x => x, y => y, (x, ygroup) => x + Enumerable.Sum(ygroup)).ToArray(),
            OneToTen.AsSpanQuery().GroupJoin(OneToTen, x => x, y => y, (x, ygroup) => x + Enumerable.Sum(ygroup)).ToArray()
            );

        // post op indices
        AssertAreEquivalent(
            OneToTen.GroupJoin(OneToTen, x => x, y => y, (x, ygroup) => x + Enumerable.Sum(ygroup)).Select((x, i) => i).ToArray(),
            OneToTen.AsSpanQuery().GroupJoin(OneToTen, x => x, y => y, (x, ygroup) => x + Enumerable.Sum(ygroup)).Select((x, i) => i).ToArray()
            );
    }
    ...
    public void Test_Last()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => none.AsSpanQuery().Last());
    }
    ...
    public void Test_Single()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => none.AsSpanQuery().Single());
        Assert.Throws<InvalidOperationException>(() => two.AsSpanQuery().Single());
    }
    ...
    public void Test_Single_Predicate()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpanQuery().Single(x => x > 10));
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpanQuery().Single(x => x > 8));
    }
    ...
    public void Test_SingleOrDefault()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => two.AsSpanQuery().SingleOrDefault());
    }
    ...
    public void Test_SingleOrDefault_Predicate()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpanQuery().SingleOrDefault(x => x > 8));
    }
