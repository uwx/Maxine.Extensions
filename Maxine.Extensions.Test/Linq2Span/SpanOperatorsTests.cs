...
public class SpanOperatorsTests : TestBase
{
    ...
    public void Test_ElementAt()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpan().ElementAt(10));
    }
    ...
    public void Test_ElementAt_Index()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpan().ElementAt((Index)10));
        Assert.AreEqual(10, OneToTen.AsSpan().ElementAt(^1));
        Assert.AreEqual(1, OneToTen.AsSpan().ElementAt(^10));
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpan().ElementAt(^0));
        Assert.Throws<ArgumentOutOfRangeException>(() => OneToTen.AsSpan().ElementAt(^11));
    }
    ...
    public void Test_First()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => none.AsSpan().First());
    }
    ...
    public void Test_First_Predicate()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpan().First(x => x > 10));
    }
    ...
    public void Test_Last()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => none.AsSpan().Last());
    }
    ...
    public void Test_Single()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => none.AsSpan().Single());
        Assert.Throws<InvalidOperationException>(() => two.AsSpan().Single());
    }
    ...
    public void Test_Single_Predicate()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpan().Single(x => x > 10));
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpan().Single(x => x > 8));
    }
    ...
    public void Test_SingleOrDefault()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => two.AsSpan().SingleOrDefault());
    }
    ...
    public void Test_SingleOrDefault_Predicate()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => OneToTen.AsSpan().SingleOrDefault(x => x > 8));
    }
