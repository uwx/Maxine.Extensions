...
[TestClass]
public class ReadOnlySpanExtensionsTests : TestBase
{
    ...
    protected static ReadOnlySpan<int> OneToTen => _OneToTen;
    protected static ReadOnlySpan<long> OneToTen_long => _OneToTen_long;
    protected static ReadOnlySpan<double> OneToTen_double => _OneToTen_double;
    protected static ReadOnlySpan<float> OneToTen_float => _OneToTen_float;
    protected static ReadOnlySpan<decimal> OneToTen_decimal => _OneToTen_decimal;
